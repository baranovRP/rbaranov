...
public class MusicTypeDaoImpl implements MusicTypeDao {
    ...
    public Long create(final MusicType musicType) {
        ...
        try (PreparedStatement pstmt =
                 conn.prepareStatement(RB_SQL.getString("insert.genre"))) {
    ...
    public boolean update(final MusicType musicType) {
        ...
        try (PreparedStatement pstmt =
                 conn.prepareStatement(RB_SQL.getString("update.genre.by.id"))) {
            pstmt.setString(1, musicType.getGenre());
    ...
    public boolean deleteById(final Long id) {
        boolean result = false;
        try (PreparedStatement pstmt =
                 conn.prepareStatement(RB_SQL.getString("delete.genre.by.id"))) {
            pstmt.setLong(1, id);
