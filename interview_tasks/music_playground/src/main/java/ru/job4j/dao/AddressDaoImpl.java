...
public class AddressDaoImpl implements AddressDao {
    ...
    public Long create(final Address address) {
        ...
        try (PreparedStatement pstmt =
                 conn.prepareStatement(RB_SQL.getString("insert.address"))) {
    ...
    public boolean update(final Address address) {
        ...
        try (PreparedStatement pstmt =
                 conn.prepareStatement(RB_SQL.getString("update.address.by.id"))) {
            pstmt.setString(1, address.getCountry());
            pstmt.setString(2, address.getCity());
            pstmt.setString(3, address.getStreetAddress());
    ...
    public boolean deleteById(final Long id) {
        boolean result = false;
        try (PreparedStatement pstmt =
                 conn.prepareStatement(RB_SQL.getString("delete.address.by.id"))) {
            pstmt.setLong(1, id);
